      ...
      <div className="container grid gap-6 py-10 md:grid-cols-3">
        ...
        <div className="space-y-2">
          ...
          <nav className="grid gap-1 text-sm">
            <Link to="/about" className="text-slate-600 hover:text-emerald-700">About</Link>
            <Link to="/contact" className="text-slate-600 hover:text-emerald-700">Contact</Link>
            <Link to="/challenges" className="text-slate-600 hover:text-emerald-700">Challenges</Link>
          </nav>
        </div>
        <div className="space-y-2">
