...
export default function Login() {
  ...
  return (
    <StaggerContainer className="mx-auto max-w-sm">
      <StaggerItem>
      ...
      <StaggerItem>
        <Button
          type="button"
          variant="outline"
          className="mt-3 w-full h-10 flex items-center justify-center gap-2"
      ...
      <StaggerItem className="mt-4 flex items-center justify-between text-sm">
